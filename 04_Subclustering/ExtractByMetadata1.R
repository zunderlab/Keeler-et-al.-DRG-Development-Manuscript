...
## Input parameters ===============================================================================
FILES_KEEP <- c(17,18,35,36) #comma separated file ID's

INPUT.FOLDER <- getwd()
OUTPUT.FOLDER <- INPUT.FOLDER
CONCATTRANSFORMED.FILENAME <- "/Concat_Transformed_Stitched.csv"
#LAYOUT.FILENAME <- "/UMAP_layout.csv"
#CLUSTERS.FILENAME <- "/clusters_FINAL.csv"
EXTRACT.OUT.FILENAME <- "Concat_Transformed_Stitched_P4.csv"
#LAYOUT.OUT.FILENAME <- "UMAP_layout_P4.csv"
#CLUSTERS.OUT.FILENAME <- "clusters_P4.csv"
