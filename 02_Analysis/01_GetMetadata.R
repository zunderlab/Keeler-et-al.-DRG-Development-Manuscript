...
#IF YOU WANT TO CREATE A PANEL.CSV, DELETE "#" FROM IN FRONT OF LINES 17 AND 47
...
#PANEL.FILENAME <- "panel.csv" #Uncomment lines 15 and 45 [last line: fwrite md.params] to generate a panel.csv
